...
- API-aware static dashboard prototype with fallback demo data, compartment-aware inventory, subnet access labels, resource IDs, and pinned home-region navigation.
