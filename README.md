...
- API-aware static dashboard prototype with fallback demo data, 5-second live refresh, compartment-aware inventory, subnet access labels, resource IDs, expanders, and pinned home-region navigation.
